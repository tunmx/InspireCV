#ifndef INSPIRECV_BACKENDS_OKCV_ADAPTER_SIZE_BACKEND_H_
#define INSPIRECV_BACKENDS_OKCV_ADAPTER_SIZE_BACKEND_H_
...
#endif  // INSPIRECV_BACKENDS_OKCV_ADAPTER_SIZE_BACKEND_H_
