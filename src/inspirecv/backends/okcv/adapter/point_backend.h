#ifndef INSPIRECV_BACKENDS_OKCV_ADAPTER_POINT_BACKEND_H_
#define INSPIRECV_BACKENDS_OKCV_ADAPTER_POINT_BACKEND_H_
#include <memory>
#include <vector>
...
#endif  // INSPIRECV_BACKENDS_OKCV_ADAPTER_POINT_BACKEND_H_
