#ifndef INSPIRECV_BACKENDS_OPENCV_ADAPTER_TRANSFORM_MATRIX_BACKEND_H_
#define INSPIRECV_BACKENDS_OPENCV_ADAPTER_TRANSFORM_MATRIX_BACKEND_H_
...
#endif  // INSPIRECV_BACKENDS_OPENCV_ADAPTER_TRANSFORM_MATRIX_BACKEND_H_
