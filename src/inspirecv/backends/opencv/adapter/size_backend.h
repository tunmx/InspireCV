#ifndef INSPIRECV_BACKENDS_OPENCV_ADAPTER_SIZE_BACKEND_H_
#define INSPIRECV_BACKENDS_OPENCV_ADAPTER_SIZE_BACKEND_H_
...
#endif  // INSPIRECV_BACKENDS_OPENCV_ADAPTER_SIZE_BACKEND_H_
